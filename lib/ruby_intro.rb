...
# argument and price as second argument, and should raise ArgumentError (one of
# Ruby's built-in exception types) if the ISBN number is the empty string or if
# the price is less than or equal to zero. Include the proper getters and
